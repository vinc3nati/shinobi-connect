...
export const SuggestedUserHorizontal = ({ user }) => {
  ...
  return (
    ...
    >
      ...
      <button className="text-white bg-gradient-to-r from-blue-600 to-gray-400 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-800 font-medium rounded text-sm px-4 py-1 text-center">
        Follow
      </button>
    </div>
  );
